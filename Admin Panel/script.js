...
let products = [
    { id: 1, name: 'Spotify', price: 54990, desc: 'Spotify adalah layanan musik digital yang memberi Anda akses ke jutaan lagu.',img : "img/Spotify_Primary_Logo_RGB_Green.png" },
    { id: 2, name: 'Netflix', price: 54000, desc: 'Tonton film & acara TV Netflix secara online atau streaming langsung ke smart TV, konsol game, PC, Mac, ponsel, tablet, dan lainnya.',img : "img/netflix-transparent-netflix-free-free-png.webp" },
  ];
  ...
  function renderProducts() {
    ...
    products.forEach((product, productIndex) => {
        ...
        makeDiv.innerHTML = `
              ...
              <img src = "${product.img}" class = "proImg" >
              <span><label id ="product-name-${productIndex}" for = "proImg" >${product.name}</label></span>
              </div>
              <div class = "harga">
